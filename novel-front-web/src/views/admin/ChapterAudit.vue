  ...
  <div class="page-container">
    <div class="page-header">
      <div class="page-header-left">
        <h2 class="page-title">章节审核</h2>
        <p class="page-subtitle">审核系统自动检测的章节内容，标记通过或拒绝</p>
      </div>
    </div>
    ...
    <el-card class="data-card" shadow="hover">
      ...
      <el-empty v-if="!loading && list.length === 0" description="暂无章节审核记录" class="empty-state">
        <template #image>
          <div class="empty-icon"><el-icon><Document /></el-icon></div>
        </template>
      </el-empty>

      <el-dialog v-model="detailVisible" title="章节内容详情" width="700px" class="detail-dialog">
...
import { Clock, Document, CircleCheck, CircleClose, Check, Close } from '@element-plus/icons-vue'
...
.author-name { color: #1a1a2e; font-size: 13px; font-weight: 500; }
