      ...
      <div class="np-login-card-wrapper">
        <div class="np-login-card">
          <div class="np-login-header">
            ...
            <h2 class="np-login-title">用户登录</h2>
            <p class="np-login-desc">欢迎回到小说精品屋</p>
          </div>
          ...
          <div class="np-login-footer">
            <span class="np-login-tip">还没有账号？</span>
            <router-link :to="{ name: 'register' }" class="np-login-link">立即注册</router-link>
          </div>
        </div>
      </div>
    </div>
...
export default {
  name: "Login",
  components: { User, Lock, Right, Check, UserFilled },
  setup() {
