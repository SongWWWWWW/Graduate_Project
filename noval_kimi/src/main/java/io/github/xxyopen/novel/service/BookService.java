...
public interface BookService {
    ...
    /**
     * 增加小说点击量（基于 IP 24h 去重）
     *
     * @param bookId 小说ID
     * @param clientIp 客户端IP
     * @return 成功状态
     */
    RestResp<Void> addVisitCount(Long bookId, String clientIp);
     ...
     *
     * @param bookId 小说ID
     * @param chapterId 章节ID;不传或0表示查询整本书评论
     * @return 小说最新评论数据
     */
    RestResp<BookCommentRespDto> listNewestComments(Long bookId, Long chapterId);
