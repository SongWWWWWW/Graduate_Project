...
public class BookController {
    ...
    public RestResp<Void> addVisitCount(@Parameter(description = "小说ID") Long bookId,
        ...
        return bookService.addVisitCount(bookId, IpUtils.getRealIp(request));
    }
    ...
    public RestResp<BookCommentRespDto> listNewestComments(
        @Parameter(description = "小说ID") Long bookId,
        @Parameter(description = "章节ID;不传或0表示整本书评论") @RequestParam(required = false) Long chapterId) {
        return bookService.listNewestComments(bookId, chapterId);
    }
